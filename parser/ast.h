...
static inline const char * node_type_to_string(NodeType type) {
    switch (type) {
        ...
        case NODE_NOT_IN: return "NOT_IN";
        case NODE_ORDER: return "ORDER";
        case NODE_LIMIT: return "LIMIT";
        case NODE_CREATE_DATABASE: return "CREATE_DATABASE";
        case NODE_DROP_DATABASE: return "DROP_DATABASE";
        case NODE_CREATE_TABLE: return "CREATE_TABLE";
        case NODE_DROP_TABLE: return "DROP_TABLE";
        case NODE_COLUMN_DEF: return "COLUMN_DEF";
...
typedef int (*NodeDataPrinter)(ASTNode* node, int indent, int offset, char* buffer, size_t buffer_size);
...
int print_string_node(ASTNode* node, int indent, int offset, char* buffer, size_t buffer_size);
...
int print_ident_node(ASTNode* node, int indent, int offset, char* buffer, size_t buffer_size);
...
ASTNode* make_select_node(const char* table, 
  ASTNode* columns,
  ASTNode* condition, 
  ASTNode* order_by,
  ASTNode* limit);
int print_select_node(ASTNode* node, int indent, int offset, char* buffer, size_t buffer_size);
...
ASTNode* make_insert_node(const char* table, 
        ASTNode* columns,
        ASTNode* values);
int print_insert_node(ASTNode* node, int indent, int offset, char* buffer, size_t buffer_size);
...
ASTNode* make_update_node(const char* table, 
  ASTNode* assignments,
  ASTNode* condition);
int print_update_node(ASTNode* node, int indent, int offset, char* buffer, size_t buffer_size);
...
int print_assignment_node(ASTNode* node, int indent, int offset, char* buffer, size_t buffer_size);
...
int print_delete_node(ASTNode* node, int indent, int offset, char* buffer, size_t buffer_size);
...
int print_compare_node(ASTNode* node, int indent, int offset, char* buffer, size_t buffer_size);
...
int print_in_node(ASTNode* node, int indent, int offset, char* buffer, size_t buffer_size);
...
int print_binary_node(ASTNode* node, int indent, int offset, char* buffer, size_t buffer_size);
...
int print_not_node(ASTNode* node, int indent, int offset, char* buffer, size_t buffer_size);
...
static inline const char* list_type_to_string(ListType type) {
    switch (type) {
        case LIST_COLUMN: return "COLUMNS";
...
int print_list(ASTNode* node, int indent, int offset, char* buffer, size_t buffer_size);
...
int print_order_node(ASTNode* node, int indent, int offset, char* buffer, size_t buffer_size);
...
int print_limit_node(ASTNode* node, int indent, int offset, char* buffer, size_t buffer_size);
...
int print_use_node(ASTNode* node, int indent, int offset, char* buffer, size_t buffer_size);
void free_use_node(ASTNode* node);

// NODE_CREATE_DATABASE
ASTNode* make_create_database_node(const char* db_name);
int print_create_database_node(ASTNode* node, int indent, int offset, char* buffer, size_t buffer_size);
void free_create_database_node(ASTNode* node);

// NODE_DROP_DATABASE
ASTNode* make_drop_database_node(const char* db_name);
int print_drop_database_node(ASTNode* node, int indent, int offset, char* buffer, size_t buffer_size);
...
int print_create_table_node(ASTNode* node, int indent, int offset, char* buffer, size_t buffer_size);
...
int print_drop_table_node(ASTNode* node, int indent, int offset, char* buffer, size_t buffer_size);
...
#define AST_NODE_SIZE(data_size) \
    (offsetof(ASTNode, data) + (data_size))

#define AST_NODE_DATA(node, type) \
    ((type*)((node)->data))

#define USE_DATA(var, node, type) \
    type* var = AST_NODE_DATA(node, type)
...
// 获取 type 的便捷宏
#define GET_AST_TYPE(data_ptr) \
    (AST_NODE_FROM_DATA(data_ptr)->type)
